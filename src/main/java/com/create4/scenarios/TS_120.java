	...
	public void CRe4_519_520_521_522_523_524_525_526_527_528_529_530_531_532() throws Exception {
		...
		//---TAKE COUNT BEFORE FROM PROJECTS WITH QUERIES--//
			...
			//---TAKE COUNT AFTER FROM PROJECTS WITH QUERIES--//
				...
				WebElement countbefore6 = GWait.Wait_GetElementByXpath("//ul[2]/li/a/span[2]");
				...
				//---TAKE COUNT AFTER FROM RESUBMISSION--//
						...
						WebElement countafter6 = GWait.Wait_GetElementByXpath("//ul[2]/li/a/span[2]");
