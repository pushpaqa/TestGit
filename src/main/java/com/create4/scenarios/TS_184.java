...
//Check for Submission status when query replied by Pi for�sae follow up submission for MS decisions
public class TS_184 extends TS_58 {
	...
	//sae follow up form fields elements
	...
	WebElement PI_history;
	 ...
	 //Check submission status when query replied by PI for sae follow up submission get MS decision as 'Letter of Permission'
	 public void CRe4_1762_1763_1764() throws Exception{
		 
	     //***********Initial project submission with LOP decision and sae follow up gets decision as Query-MS**********//
		 ...
		 System.out.println("First "+TS_58.querydoccount);

		 for (int i =TS_58.querydoccount; i<=docvalue2.size()-1; i++)
			 {
			 System.out.println("Second "+TS_58.querydoccount);
			 Thread.sleep(2000);
...
//		Check submission status when query replied by PI for sae follow up submission get MS decision as 'Disapproval Letter'
	 ...
	 //Check submission status when query replied by PI for sae follow up submission get MS decision as 'Provisional Letter of Permission
	...
	//Check submission status when query replied by PI for sae follow up submission get MS decision as 'Query Letter � MS'
	 ...
	 //Check submission status when query replied by PI for sae follow up submission get MS decision as 'Query Letter � Full Board'
	 ...
	 //Check submission status when query replied by PI for sae follow up submission get MS decision as 'Query Letter � Reviewers'
	 ...
	 //Check submission status when query replied by PI for sae follow up submission get MS decision as 'Withdrawal letter''
	 ...
	 //Check submission status when query replied by PI for sae follow up submission get MS decision as Termination letter'
