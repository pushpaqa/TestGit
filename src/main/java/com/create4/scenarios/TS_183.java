...
//Check for Submission status when query replied by Pi for�sae initial submission for MS decisions
public class TS_183 extends TS_57 {
	...
	//sae initial form fields elements
	...
	WebElement PI_history;
	 ...
	 //Check submission status when query replied by PI for sae initial submission get MS decision as 'Letter of Permission'
	 public void CRe4_1688_1689_1690() throws Exception{
		 
	     //***********Initial project submission with LOP decision and sae initial gets decision as Query-MS**********//
		 ...
		 System.out.println("First "+TS_57.querydoccount);

		 for (int i=TS_57.querydoccount; i<=docvalue2.size()-1; i++)
		 {
			 System.out.println("Second "+TS_57.querydoccount);
...
//		Check submission status when query replied by PI for sae initial submission get MS decision as 'Disapproval Letter'
	 ...
	 //Check submission status when query replied by PI for sae initial submission get MS decision as 'Provisional Letter of Permission
	...
	//Check submission status when query replied by PI for sae initial submission get MS decision as 'Query Letter � MS'
	 ...
	 //Check submission status when query replied by PI for sae initial submission get MS decision as 'Query Letter � Full Board'
	 ...
	 //Check submission status when query replied by PI for sae initial submission get MS decision as 'Query Letter � Reviewers'
	 ...
	 //Check submission status when query replied by PI for sae initial submission get MS decision as 'Withdrawal letter''
	 ...
	 //Check submission status when query replied by PI for sae initial submission get MS decision as Termination letter'
