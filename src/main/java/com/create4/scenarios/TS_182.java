...
//Check for Submission status when query replied by Pi for�termination submission for MS decisions
public class TS_182 extends TS_56 {
	...
	//termination form fields elements
	...
	WebElement PI_history;
	 ...
	 //Check submission status when query replied by PI for termination submission get MS decision as 'Letter of Permission'
	 public void CRe4_1624_1625_1626() throws Exception{
		 
	     //***********Initial project submission with LOP decision and termination gets decision as Query-MS**********//
		 ...
		 System.out.println("First "+TS_56.querydoccount);

		 for (int i =TS_56.querydoccount; i<=docvalue2.size()-1; i++)
			 {
			 System.out.println("Second "+TS_56.querydoccount);
			 Thread.sleep(2000);
...
//		Check submission status when query replied by PI for termination submission get MS decision as 'Disapproval Letter'
 ...
 System.out.println(docvalue2.size()-1);
	 ...
	 //Check submission status when query replied by PI for termination submission get MS decision as 'Provisional Letter of Permission
	...
	//Check submission status when query replied by PI for termination submission get MS decision as 'Query Letter � MS'
 ...
 System.out.println(docvalue2.size()-1);
	 ...
	 //Check submission status when query replied by PI for termination submission get MS decision as 'Query Letter � Full Board'
 ...
 System.out.println(docvalue2.size()-1);
	 ...
	 //Check submission status when query replied by PI for termination submission get MS decision as 'Query Letter � Reviewers'
 ...
 System.out.println(docvalue2.size()-1);
	 ...
	 //Check submission status when query replied by PI for termination submission get MS decision as 'Withdrawal letter''
 ...
 System.out.println(docvalue2.size()-1);
	 ...
	 //Check submission status when query replied by PI for termination submission get MS decision as Termination letter'
