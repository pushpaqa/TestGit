...
//Check for Submission status when query replied by Pi for�withdrawl submission for MS decisions
public class TS_186 extends TS_60 {
	...
	//withdrawal form fields elements
	...
	WebElement PI_history;
	 ...
	 //Check submission status when query replied by PI for withdrawal submission get MS decision as 'Letter of Permission'
	 public void CRe4_1909_1910_1911_1912_1913() throws Exception{
		 
	     //***********Initial project submission with LOP decision and withdrawal gets decision as Query-MS**********//
		 ...
		 System.out.println("First "+TS_60.querydoccount);

		 for (int i =TS_60.querydoccount; i<=docvalue2.size()-1; i++)
			 {
			 System.out.println("Second "+TS_60.querydoccount);
			 Thread.sleep(2000);
...
//		Check submission status when query replied by PI for withdrawal submission get MS decision as 'Disapproval Letter'
	 ...
	 //Check submission status when query replied by PI for withdrawal submission get MS decision as 'Provisional Letter of Permission
	...
	//Check submission status when query replied by PI for withdrawal submission get MS decision as 'Query Letter � MS'
	 ...
	 //Check submission status when query replied by PI for withdrawal submission get MS decision as 'Query Letter � Full Board'
	 ...
	 //Check submission status when query replied by PI for withdrawal submission get MS decision as 'Query Letter � Reviewers'
	 ...
	 //Check submission status when query replied by PI for withdrawal submission get MS decision as 'Withdrawal letter''
	 ...
	 //Check submission status when query replied by PI for withdrawal submission get MS decision as Termination letter'
