...
GlobalWait GWait = new GlobalWait(GlobalMethods.driver);
	...
	public void CRe4_557_558_559_560_561() throws Exception{
		...
		String announce_title = r1.getCell(2, 35).getContents();
		String announce_desc = r1.getCell(3, 35).getContents();
		String announce_file = r1.getCell(4, 35).getContents();
		String announce_date = r1.getCell(5, 35).getContents();
		String announce_acknowledge = r1.getCell(6, 35).getContents();
