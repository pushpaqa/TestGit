...
//Check for Submission status when query replied by Pi for�completion submission for MS decisions
public class TS_181 extends TS_55 {
	...
	//completion form fields elements
	...
	WebElement PI_history;
	 ...
	 //Check submission status when query replied by PI for completion submission get MS decision as 'Letter of Permission'
	 public void CRe4_1545_1546_1547() throws Exception{
		 
	     //***********Initial project submission with LOP decision and completion gets decision as Query-MS**********//
		 ...
		 System.out.println("First "+TS_55.querydoccount);

		 for (int i =TS_55.querydoccount; i<=docvalue2.size()-1; i++)
			 {
			 System.out.println("Second "+TS_55.querydoccount);
			 Thread.sleep(2000);
...
//		Check submission status when query replied by PI for completion submission get MS decision as 'Disapproval Letter'
	 public void CRe4_1555_1556_1557() throws Exception{
	 ...
	 //Check submission status when query replied by PI for completion submission get MS decision as 'Provisional Letter of Permission
	 public void CRe4_1560_1561_1562() throws Exception{
	...
	//Check submission status when query replied by PI for completion submission get MS decision as 'Query Letter � MS'
	 public void CRe4_1565_1566_1567() throws Exception{	
	 ...
	 //Check submission status when query replied by PI for completion submission get MS decision as 'Query Letter � Full Board'
	 public void CRe4_1570_1571_1572() throws Exception{
	 ...
	 //Check submission status when query replied by PI for completion submission get MS decision as 'Query Letter � Reviewers'
	 public void CRe4_1575_1576_1577() throws Exception{
		...
		//**********************Check for the Edit option after Query-letter reviewers**************//
		 ...
		 WebElement query_reply_dashboardA1 = GWait.Wait_GetElementByXpath("//li[3]/a/span");
		 query_reply_dashboardA1.click();
	 ...
	 //Check submission status when query replied by PI for completion submission get MS decision as 'Withdrawal letter''
	 public void CRe4_1580_1581_1582() throws Exception{	
	 ...
	 //Check submission status when query replied by PI for completion submission get MS decision as Termination letter'
	 public void CRe4_1585_1586_1587() throws Exception{	
